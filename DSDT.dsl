 ...
 *
 * Disassembly of iASLp6Elrd.aml, Sat Jul 22 17:22:03 2017
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000BEF0 (48880)
 *     Revision         0x02
 *     Checksum         0x7B
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I"
 ...
 */
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I", 0x000000F9)
{
    /*
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xCE9C6C18, 0x027E)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xCE8DAE18, 0x10)
    ...
    Scope (_SB)
    {
        Device (PTMD)
        {
            ...
            {
                OperationRegion (GCAD, SystemMemory, 0xCE9B6018, 0x00FC)
            ...
            {
                OperationRegion (GDAD, SystemMemory, 0xCE9B4018, 0x05F8)
